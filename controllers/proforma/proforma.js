...
const addProforma = async(req, res) => {
    try{
        ...
        .query(` INSERT INTO cliente (id_cliente, id_motos, id_asesores, id_sucursal, plazo, precious, inicialbs, cuota_mes) 
            VALUES (@id_cliente, @id_motos, @id_asesores, @id_sucursal, @plazo, @precious, @inicialbs, @cuota_mes)`);
